    ...
    <section className="py-12 md:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-50 to-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div ref={headerRef} className="text-center mb-12 md:mb-16">
          <span className="inline-block px-4 py-2 bg-blue-50 text-[#1393c4] rounded-full text-sm font-medium mb-3 transition-all duration-300 hover:shadow-lg hover:shadow-[#1393c4]/20 opacity-0 translate-y-4">
            Our Process
          </span>
          ...
          {services.map((service, index) => (
            ...
            >
                ...
                <div className="w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 lg:w-32 lg:h-32 flex items-center justify-center opacity-0 scale-95 transition-all duration-700">
                  <img
                    ...
                    onError={(e) => {
                      ...
                      parent.innerHTML = `<div class="w-full h-full flex items-center justify-center bg-gradient-to-br from-[#5b8def] to-[#1393c4] rounded-lg">
              ...
              <div className="space-y-3 max-w-xs">
                <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-[#1393c4] transition-all duration-300 group-hover:scale-105 opacity-0 translate-y-4 transition-all duration-700">
                  <span className="inline-block transition-all duration-300">
                    {service.title}
                  </span>
                </h3>
                
                <p className="text-[#1393c4] text-base sm:text-lg leading-relaxed transition-all duration-300 group-hover:opacity-100 opacity-90 opacity-0 translate-y-4 transition-all duration-700">
