  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-cyan-50">
      ...
      <main className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-4 sm:py-6 lg:py-8">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3">
              {cities.map((city, index) => (
                <button
                  ...
                  className={`shine-effect relative p-3 sm:p-4 rounded-2xl border-3 transition-all duration-300 ${selectedCity === city.id ? 'shadow-2xl scale-105 bg-gradient-to-br from-blue-50 to-cyan-50' : 'border-gray-200 hover:shadow-xl hover:scale-102 bg-white'
                    }`}
                  style={{
                ...
                >
                  ...
                  {selectedCity === city.id && (
                    <div className="absolute top-1 right-1 sm:top-2 sm:right-2 bg-white rounded-full p-1 shadow-lg">
        ...
        <section className="mb-6 sm:mb-8 md:mb-10">
          <div className="glass-effect rounded-3xl shadow-2xl p-4 sm:p-5 md:p-6 glow-card mobile-section scroll-animate">
            <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
              ...
              {['laundry', 'ironing', 'drycleaning'].map((type, index) => (
                <div key={type} className="scroll-animate">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border-2 rounded-xl focus:outline-none text-sm sm:text-base font-semibold transition-all duration-200 bg-white"
            ...
            {calculateTotal() > 0 && (
              <div className="rounded-2xl p-4 sm:p-5 border-3 glow-card bg-gradient-to-br from-blue-50 via-white to-cyan-50 scroll-animate"
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-4">
                  ...
                  <button
                    ...
                    className="shine-effect w-full sm:w-auto text-white px-4 sm:px-6 py-2 sm:py-3 rounded-xl font-bold text-sm sm:text-base shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-110 mt-3 sm:mt-0 bg-gradient-to-r from-[#1aa6b3] to-[#0d7c87]"
                  >
                    Book Now
                  </button>
                </div>
        ...
        <section className="text-center scroll-animate">
          <div className="bg-gradient-to-r from-[#1aa6b3] via-teal-500 to-[#1aa6b3] rounded-3xl p-4 sm:p-6 md:p-8 lg:p-10 shadow-2xl glow-card bg-[length:200%_auto] animate-[shimmer_3s_linear_infinite]">
            ...
            <button
              onClick={onBookingClick}
              className="shine-effect bg-white text-sm sm:text-base md:text-lg font-bold px-4 sm:px-6 md:px-8 py-2 sm:py-3 md:py-4 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-110"
              style={{ color: primaryColor }}
            >
              Book Your Order Now
            </button>
