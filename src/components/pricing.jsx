...
const PricingOffers = ({ onClose, onBookingClick }) => {
  ...
  // Changed primary color to #1aa6b3 (Eastern Blue)
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
      <style>{`
        @keyframes glow {
          0%, 100% { box-shadow: 0 0 20px rgba(26, 166, 179, 0.3), 0 0 40px rgba(26, 166, 179, 0.2); }
          50% { box-shadow: 0 0 30px rgba(26, 166, 179, 0.5), 0 0 60px rgba(26, 166, 179, 0.3); }
        }
        @keyframes float {
        ...
        .glow-card:hover {
          ...
          box-shadow: 0 0 40px rgba(26, 166, 179, 0.6), 0 0 80px rgba(26, 166, 179, 0.4);
        }
        .float-animation { animation: float 3s ease-in-out infinite; }
        .price-animate { animation: priceChange 0.6s ease-in-out; }
        .gradient-text {
          background: linear-gradient(135deg, #1aa6b3 0%, #147c86 100%);
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-2 sm:py-3">
          <div className="flex items-center justify-between gap-1 sm:gap-2">
            ...
            <div className="flex items-center gap-1 sm:gap-2 flex-shrink-0">
              <span className="mobile-header-badge px-2 py-1 sm:px-3 sm:py-1.5 rounded-full font-bold bg-gradient-to-r from-[#1aa6b3] to-teal-600 text-white shadow-lg glow-card">
                20% OFF 1st Order
              </span>
      ...
      <main className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-4 sm:py-6 lg:py-8">
        ...
        <section className="mb-6 sm:mb-8 md:mb-10 city-section-visible">
          <div className="bg-white rounded-2xl shadow-xl p-4 sm:p-5 md:p-6 glow-card mobile-section">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3">
              {cities.map((city, index) => (
                <button
                  ...
                  className={`shine-effect relative p-3 sm:p-4 rounded-xl border-2 transition-all duration-300 ${selectedCity === city.id ? 'shadow-xl scale-105 bg-blue-50' : 'border-gray-200 hover:shadow-lg hover:scale-102 bg-white'
                    }`}
                  style={{
            ...
            <div className="mt-3 text-center">
              <p className="text-xs text-[#1aa6b3] italic">
        ...
        <section className="text-center scroll-animate">
          <div className="bg-gradient-to-r from-[#1aa6b3] to-teal-600 rounded-2xl p-4 sm:p-6 md:p-8 lg:p-10 shadow-2xl glow-card">
