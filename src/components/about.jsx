      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          ...
          <div ref={contentRef} className="w-full lg:w-1/2">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6" style={{ color: '#1aa6b3' }}>
              About <span className="font-extrabold">LaundryForAll</span>
            </h1>
            
            <div className="space-y-4 text-base sm:text-lg leading-relaxed" style={{ color: '#1aa6b3' }}>
              <p className="opacity-90">
                <span className="font-semibold" style={{ color: '#1aa6b3' }}>LaundryForAll</span> was founded to revolutionize laundry for tourists and locals in Rajasthan. Our mission is to provide <span className="font-semibold">hotel-quality cleaning</span> with personal service and convenience.
              </p>
              ...
              <p className="opacity-90">
                We value <span className="font-semibold" style={{ color: '#1aa6b3' }}>sustainability and customer satisfaction</span>: all cleaning agents are gentle and eco-friendly, and we never use harsh chemicals that could affect sensitive skin.
              </p>

              <h2 className="text-2xl sm:text-3xl font-bold pt-4 pb-2" style={{ color: '#1aa6b3' }}>
                Why <span>LaundryForAll?</span>
              </h2>

              <ul className="space-y-3 mt-4">
                <li className="flex items-start opacity-90">
                  <span className="inline-block mr-2 mt-1 text-xl" style={{ color: '#1aa6b3' }}>•</span>
